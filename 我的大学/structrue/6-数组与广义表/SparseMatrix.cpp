...
/*输入三元组*/
void inputMatrix(int zero, TripleMatrix &triple) {
    int row;
    int col;
    int Elem;
    for (int i = 1; i <= zero; ++i) {
...
int main()
{
    ...
    int y;
    int zero;
    printf("input matrix's rows, cols and zero: ");
    scanf("%d", &x);
    scanf("%d", &y);
    scanf("%d", &zero);
    TripleMatrix triple(x, y, zero);
    inputMatrix(zero, triple);
    printf("\ntriple ------------------------------------\n");
    triple.printTriple();
    triple.printMatrix();
    printf("\n\n");
    ...
    //----------------------------------
    TripleMatrix add1(4, 5, 6);
    inputMatrix(6, add1);
    TripleMatrix add2(4, 5, 5);
    inputMatrix(5, add2);
    TripleMatrix sum(4, 5, 0);
    matrixAdd(add1, add2, sum);
    printf("\nadd1 ------------------------------------\n");
    add1.printMatrix();
    printf("\nadd2 ------------------------------------\n");
    add2.printMatrix();
    ...
    //----------------------------------
    TripleMatrix mul1(6, 4, 12);
    inputMatrix(12, mul1);
    TripleMatrix mul2(4, 5, 6);
    inputMatrix(6, mul2);
    TripleMatrix prod(6, 5, 0);
    matrixMulty(mul1, mul2, prod);
    printf("\nmul1 ------------------------------------\n");
    mul1.printMatrix();
    printf("\nmul2 ------------------------------------\n");
    mul2.printMatrix();
